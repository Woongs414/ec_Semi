...
if(!($('#req1').is(':checked'))){
	...
	location.href="${contextPath}/seller/memberForm_sdetail.do";
	}
}
...
location.href="${contextPath}/seller/s_regadmin.do";}
</script>
<meta charset="UTF-8">
<title>약관동의</title>
...
<body>
<form action="${contextPath }/memberForm_sdetail.do" method="post">
<table width="100%" height="650">
  <tr>
   ...
   <span><a href="${contextPath }/main.do"><img src="${contextPath }/image/logo.png" width="250px" height="250px" alt="로고사진"></a>
   </span>
   </p>
   <br>
   <textarea
